...
//Configuracion render canvas personalizado.
sigma.canvas.edges.dirigido = function(edge, source, target, context, settings, peso) {
...
sigma.canvas.edges.noDirigido = function(edge, source, target, context, settings) {
    var color = edge.color,
        prefix = settings('prefix') || '',
        size = edge[prefix + 'size'] || 1,
        edgeColor = settings('edgeColor'),
